	...
	void initColor()
	{
		switch (mood)
		{
			...
			case "2":
				...
				getColor(new Color(1,0.06666667f,0.5333334f), new Color(1,0.7058824f,0.1058824f));
				break;
			case "3":
				// moodName = "mysterieux";
				getColor(new Color(0.05882353f,0.1019608f,0.2941177f),new Color(0.5490196f,0.09411765f,0.4862745f));
				break;
		}
	}
